		...
		rows.append(
			{
				...
				"entsoe_pl_lag24_delta_1h_uah_mwh": 0.0 if index == 0 else 25.0,
				"entsoe_pl_lag24_delta_24h_uah_mwh": 0.0 if index < 24 else 600.0,
				...
				"entsoe_pl_lag24_morning_block_mean_uah_mwh": 3337.5,
				"entsoe_pl_lag24_evening_block_mean_uah_mwh": 3637.5,
				"entsoe_pl_lag24_evening_morning_spread_uah_mwh": 300.0,
				"entsoe_pl_lag24_price_rank_centered": float(index % 24) / 23.0 - 0.5,
				"entsoe_pl_lag24_peak_trough_span_hours": 23.0,
				"entsoe_pl_lag24_ua_spread_uah_mwh": price - 3000.0,
				"entsoe_pl_lag24_ua_spread_delta_24h_uah_mwh": (
					0.0 if index < 24 else 100.0
				),
				"entsoe_pl_lag24_ua_spread_ratio": (price - 3000.0) / 3000.0,
				"entsoe_pl_lag24_ua_rank_disagreement": 0.0,
				"entsoe_pl_lag24_ua_peak_hour_delta": 0.0,
				"entsoe_pl_lag24_ua_trough_hour_delta": 0.0,
				"entsoe_pl_lag24_ua_spread_momentum_sign": 1.0 if index >= 24 else 0.0,
				"entsoe_pl_lag24_pl_daily_spread_uah_mwh": 575.0,
				"entsoe_pl_lag24_ua_daily_spread_uah_mwh": 575.0,
				"entsoe_pl_lag24_rolling_24h_mean_uah_mwh": 3487.5,
				"entsoe_pl_lag24_rolling_24h_min_uah_mwh": 3200.0,
				"entsoe_pl_lag24_rolling_24h_max_uah_mwh": 3775.0,
				"entsoe_pl_lag24_rolling_24h_spread_uah_mwh": 575.0,
				"entsoe_pl_lag24_rolling_168h_mean_uah_mwh": 3487.5,
				"entsoe_pl_lag24_rolling_168h_spread_uah_mwh": 575.0,
				"entsoe_pl_lag24_price_vs_rolling_24h_mean_uah_mwh": price - 3487.5,
...
def test_neural_forecast_silver_assets_are_registered_without_dashboard_contracts() -> None:
	...
	deps_by_key = {
		asset_key.to_user_string(): {
			dependency.to_user_string()
			for dependency in asset.asset_deps.get(asset_key, set())
		}
		for asset in NEURAL_FORECAST_SILVER_ASSETS
