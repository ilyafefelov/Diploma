...
def test_operator_recommendation_exposes_dam_preview_boundary_metadata(client: TestClient) -> None:
	...
	assert response_payload["v13_readiness"]["gate_status"] == "missing_v13_acquisition_packet"
	...
	assert response_payload["v13_readiness"]["missing_safe_switch_examples"] == 0
	assert response_payload["v13_readiness"]["missing_required_inputs"] == []
	assert response_payload["v13_readiness"]["top_priority_blocker"] == "v13_acquisition_packet"
	assert response_payload["v13_readiness"]["receipt_source_audit_probe_count"] == 0
	...
	assert response_payload["v13_readiness"]["receipt_source_audit_all_probes_insufficient"] is False
	assert response_payload["v13_readiness"]["source_governance_status"] == "v13_source_packet_unavailable"
	assert response_payload["v13_readiness"]["source_governance_label"] == "V13 source packet unavailable"
	assert response_payload["v13_readiness"]["market_submission_receipt_gate_status"] == "missing_v13_packet"
	assert response_payload["v13_readiness"]["scmo_credentials_required_for_diploma_mvp"] is False
	assert response_payload["v13_readiness"]["scmo_credentials_required_for_market_submission_grade_receipts"] is False
	assert response_payload["v13_readiness"]["safe_switch_target_tenant_source_count"] == 0
	assert response_payload["v13_readiness"]["safe_switch_max_new_examples_required"] == 0
	assert response_payload["v13_readiness"]["safe_switch_acquisition_targets"] == []
