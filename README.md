...
- Research layer: forecast diagnostics, value-aware ensemble gate, calibrated horizon-aware ensemble gate, DFL-ready training table, scalar and horizon-aware regret-weighted TFT/NBEATSx calibration, strict LP/oracle re-evaluation.
...
Interpretation: horizon-aware TFT calibration is the first diagnostic to beat the strict control on mean regret, but strict similar-day still has better median regret and more rank-1 wins. The calibrated ensemble gate is a negative selector result: it is better than raw compact neural candidates but worse than both strict and horizon-TFT. This is not full DFL and is not a dashboard default yet; it is evidence that horizon-structured value calibration is worth expanding into a real DFL objective.
...
Latest full verification: `94 passed`.

## Research Artifacts

- Main report: `docs/technical/deep-research-reports/real-data-90-anchor-benchmark-report.md`
- Latest exports: `data/research_runs/calibrated_ensemble_20260505T143258/`
- Latest DB dump: `data/db_backups/smart_arbitrage_calibrated_ensemble_20260505T143258.dump`
