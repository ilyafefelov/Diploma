...
| **Compute/offload switching** | [technical/DFL_TRAINING_COMPUTE_OPTIONS.md](technical/DFL_TRAINING_COMPUTE_OPTIONS.md) · [technical/OFFICIAL_EVIDENCE_ATTEMPT_INTERFACE.md](technical/OFFICIAL_EVIDENCE_ATTEMPT_INTERFACE.md) — local/HF Jobs switching, receipts, token boundary, and Offline Strategy Promotion claim boundary |
