...
- ✅ ENTSO-E neighbor-market access gate — `entsoe_neighbor_market_query_spec_frame` records `A44/A01` day-ahead price query specs for Poland, Slovakia, Hungary, Romania, and a Moldova review placeholder, while blocking fetch/training without an ENTSO-E token; see [ENTSOE_NEIGHBOR_MARKET_ACCESS_GATE.md](technical/ENTSOE_NEIGHBOR_MARKET_ACCESS_GATE.md).
