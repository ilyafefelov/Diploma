...
| **DFL/DT bridge evidence** | [technical/DFL_V2_PLUS_DFL_DT_BRIDGE.md](technical/DFL_V2_PLUS_DFL_DT_BRIDGE.md) · [technical/DFL_OBJECTIVE_REDESIGN_PLAN.md](technical/DFL_OBJECTIVE_REDESIGN_PLAN.md) — compact and official V2+-teacher negative evidence plus the DFL v2 objective redesign plan |
