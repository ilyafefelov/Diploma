...
- ✅ Candidate-Value DFL v3 experiment definition — `dfl_official_global_panel_schedule_candidate_library_v3_frame`, `dfl_official_global_panel_candidate_value_dfl_v3_frame`, and the strict benchmark test a candidate-level value scorer over expanded failure-mode schedules while keeping V2+ as frozen comparator. See [DFL_CANDIDATE_VALUE_DFL_V3.md](technical/DFL_CANDIDATE_VALUE_DFL_V3.md).
