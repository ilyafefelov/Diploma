...
| **DFL/DT bridge evidence** | [technical/DFL_V2_PLUS_DFL_DT_BRIDGE.md](technical/DFL_V2_PLUS_DFL_DT_BRIDGE.md) — compact bridge negative evidence plus the official V2+-teacher bridge path |
...
- ✅ V2+-anchored DFL/DT bridge evidence — the compact residual DFL / offline DT bridge and the official V2+-teacher bridge are both valid negative evidence because neither beats V2+; the result is documented in [DFL_V2_PLUS_DFL_DT_BRIDGE.md](technical/DFL_V2_PLUS_DFL_DT_BRIDGE.md).
