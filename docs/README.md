...
- ✅ Official evidence-attempt interface — local batch runners and Hugging Face Jobs payloads now emit a manifest with batch plan, resume policy, asset selections, and Offline Strategy Promotion claim boundary; see [OFFICIAL_EVIDENCE_ATTEMPT_INTERFACE.md](technical/OFFICIAL_EVIDENCE_ATTEMPT_INTERFACE.md).
