...
| DFL/DT ще не готові до production-рівня                                         | Це цільова research novelty, але не результат Week 2                                          | Тримати DFL/DT як planned research lane до проходження strict evidence gates                   |
