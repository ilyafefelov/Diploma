...
.\.venv\Scripts\python.exe -m pytest -p no:cacheprovider tests\dfl\test_dt_research_shadow.py tests\api\test_main.py::test_apples_to_apples_dt_shadow_preview_uses_real_v2_plus_artifacts
cd dashboard
