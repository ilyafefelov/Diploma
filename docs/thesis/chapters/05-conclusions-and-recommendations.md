...
| Перевірити ML/DFL потенціал | V2+ став confirmed offline comparator/evidence, corrected DT/V2+ safe-switch shadow дав 168.16 UAH mean regret | Система показує improvement, але не overclaim-ить promotion |
