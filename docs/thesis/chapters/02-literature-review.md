...
Окремий висновок із сучасної EPF-літератури стосується exogenous variables та market coupling. NeuralForecast/NBEATSx технічно підтримує historical, future і static exogenous features, але така підтримка є коректною лише за умови правильної temporal availability. Дослідження ринків із market coupling та neighboring-zone prices показують, що суміжні ринкові сигнали можуть покращувати day-ahead forecasting, проте їхня користь залежить від feature selection, gate-closure timing, регулярної recalibration і ринкового контексту. Для дипломної роботи це означає, що польські або інші сусідні ціни можуть бути лише prior-only covariates, а не довільно доданими training rows.
