...
залишатися локальним архівом і не повинні бути частиною Git history. Нижче
залишено систематизований індекс для наукового керівника: назви файлів, DOI,
arXiv/source URLs і роль у дипломі.
