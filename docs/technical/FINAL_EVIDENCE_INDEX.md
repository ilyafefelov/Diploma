...
| Causal temporal episode corpus is materialized | v1.3 preparatory evidence | [corpus record](final-evidence/v1_3_causal_temporal_episode_corpus.md), [result JSON](../../arxiv/evidence/lineage/v1_3_causal_temporal_episode_corpus.json) | 1,825 time-ordered 24-hour episodes; DT training remains V13-blocked |
| Temporal DT protocol is preregistered before any training | v1.3 frozen protocol | [DT preregistration](final-evidence/v1_3_temporal_dt_preregistration.md) | execution remains blocked until V13 source-family gate passes |
...
| [final-evidence/v1_3_causal_temporal_episode_corpus.md](final-evidence/v1_3_causal_temporal_episode_corpus.md) | Forecast-only state/action/label episode contract with 43,800 temporal rows; no DT training claim. |
| [final-evidence/v1_3_temporal_dt_preregistration.md](final-evidence/v1_3_temporal_dt_preregistration.md) | Frozen temporal-DT architecture, split, causal-state, projection, and evaluation protocol. |
